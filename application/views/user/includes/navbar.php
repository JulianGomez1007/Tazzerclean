            ...
            <nav class="navbar navbar-expand-lg header-nav">
                ...
                <ul class="nav header-navbar-rht">
                    <?php if ($this->session->userdata('id') == '') { ?>
                             ...
                             <li><a class="btn btn-primary" href="javascript:void(0);" data-toggle="modal" data-target="#modal-wizard1"><?php echo (!empty($user_language[$user_selected]['lg_become_user'])) ? $user_language[$user_selected]['lg_become_user'] : $default_language['en']['lg_become_user']; ?></a></li>
                        <?php
                    }
                    $wallet = 0;
                    $token = '';
