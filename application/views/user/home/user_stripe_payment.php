...
(
	...
	"private_live_key" => "",
	"public_live_key"  => "",
	"private_test_key" => "sk_test_51IqMFXHju5x0nEpBbNLpxdTmHAYxqIiqEQYVTazFrnL7HhBYCkj8fWF2BT4LNQCJpEeDhNZ2hid0RKAZzSLp0NWE00FWocTPU2",
	"public_test_key"  => "pk_test_51IqMFXHju5x0nEpBZ8FIp94VYIpN3Nu3A9ZCwO5wYSXbTKZ73rUuueMzOOKr4Ms3hQIb5cnc47nncqLzr3bTIrZr00ihG8324v"
);
?>
...
Stripe.setPublishableKey('<?php if ($params['testmode'] == "on")  echo $params['public_test_key']; else echo $params['public_live_key']; ?>');
$(function() 
{
