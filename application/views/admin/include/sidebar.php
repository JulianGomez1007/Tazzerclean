		...
		<div id="sidebar-menu" class="sidebar-menu">
			<ul>
				...
				<li class="<?php echo ($page == 'adminusers')?'active':''; echo ($page == 'edit_adminuser')?'active':''; echo ($page == 'adminuser_details')?'active':'';?>" >
					<a href="<?php echo $base_url; ?>adminusers"><i class="fas fa-user"></i> <span>Staffs</span></a>
				</li>
				...
				<li class="<?php echo ($active =='total-report' || $active =='pending-report' || $active == 'inprogress-report' || $active == 'complete-report' || $active == 'reject-report' || $active == 'cancel-report' ||$active == 'reject-payment/(:num)')? 'active':''; ?>">
					<a href="<?php echo $base_url; ?>admin/total-report"><i class="far fa-calendar-check"></i> <span> Manage Booking</span></a>
				</li>
				...
				<li class="<?php echo ($page == 'contact')?'active':''; ?>">
					<a href="<?php echo $base_url; ?>admin/contact"><i class="fas fa-layer-group"></i> <span>Enquiries</span></a>
				</li>
				<?php } ?>
				...
				<li class="<?php echo ($page == 'review-reports')?'active':''; echo ($page == 'add-review-reports')?'active':''; echo ($page == 'edit-review-reports')?'active':'';?>">
					 <a href="<?php echo $base_url; ?>review-reports"><i class="fas fa-star"></i> <span>User Ratings</span></a>
				</li>
				...
				<li class="<?php echo ($page == 'subscriptions')?'active':''; echo ($page == 'add-subscription')?'active':''; echo ($page == 'edit-subscription')?'active':'';?>">
					<a href="<?php echo $base_url; ?>subscriptions"><i class="far fa-calendar-alt"></i> <span>Manage Subscriptions</span></a>
				</li>
				...
				<li class="<?php echo ($page == 'Revenue')?'active':'';?>" >
					<a href="<?php echo $base_url; ?>Revenue"><i class="fas fa-percent"></i> <span>Profit</span></a>
				</li>
...
<?php if($admin_id==1){ ?>		
				...
				<li class="<?php echo ($page == 'term_condition')?'active':'';?>">
					<a href="<?php echo $base_url; ?>admin/term_condition"><i class="fas fa-layer-group"></i> <span>Term Condition</span></a>
				</li> 



				<li class="<?php echo ($page == 'term_condition')?'active':'';?>">
					<a href="<?php echo $base_url; ?>admin/privacy_policy"><i class="fas fa-layer-group"></i> <span>Privacy Policy</span></a>
				</li> 
